...
- [ ] Requirements are authored in `project-spec/` as numbered files (`00`-`10`) before implementation.
- [ ] Planned changes stay within Turborepo boundaries: `apps/web` and `packages/{schema, ai, database, integrations, ui}`.
...
# [REMOVE IF UNUSED] Option 4: Turborepo monorepo (VibePipeline default)
apps/
└── web/
    ├── app/
    ├── src/
